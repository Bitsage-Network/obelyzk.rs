...
///
/// Returns an error if:
/// - The executable has no standalone entrypoint
/// - Program creation fails
/// - Program execution fails
pub fn execute(executable: Executable, args: Vec<Arg>) -> Result<CairoRunner> {
