...
| **Recursive STARK** | Production | 981 felts, 1 TX, verified on Sepolia ([TX](https://sepolia.starkscan.co/tx/0x276c6a448829c0f3975080914a89c2a9611fc41912aff1fddfe29d8f3364ddc)) |
...
|----------|---------|---------|
| **Recursive Verifier** | [`0x707819de...`](https://sepolia.starkscan.co/contract/0x1c208a5fe731c0d03b098b524f274c537587ea1d43d903838cc4a2bf90c40c7) | 1-TX STARK verification (OODS+Merkle+FRI+PoW) |
...
|-------|--------|-------------------|-----------------|
| SmolLM2-135M (1 layer) | 135M | 3.3s | 981 |
| SmolLM2-135M (30 layers) | 135M | 95s | 981 |
| Qwen2-0.5B | 494M | ~20s | 981 |
| Llama-3.2-3B | 3B | ~35s | 981 |
| Phi-3-mini | 3.8B | ~45s | 981 |
| Mistral-7B | 7B | ~90s | 981 |
| Qwen3-14B (H100) | 14B | 103s | 981 |
