...
All SDKs default to `https://api.obelysk.com`. Set `OBELYZK_API_URL` to point at a self-hosted prover.
...
|---|---|---|
| `OBELYZK_API_URL` | `https://api.obelysk.com` | Prover API endpoint for SDKs and CLI |
